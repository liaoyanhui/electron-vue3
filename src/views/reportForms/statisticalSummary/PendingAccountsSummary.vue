 ...
 * @LastEditTime: 2024-03-22 01:34:54
 * @FilePath: /cbank-client/src/views/reportForms/statisticalSummary/PendingAccountsSummary.vue
-->
<template>
  <div class="app-container content-box p-24">
    ...
    <div>
      <el-table :data="tableList" class="ml10 tbg" ref="tableRef">
        ...
        <el-table-column label="挂账责任人" align="center" prop="pendingUser"  />
        <el-table-column label="挂账金额" align="center" prop="pendingAccount" :formatter="(a,b,c,d) => fenToYuan(c)" />
        <el-table-column label="已回收金额" align="center" prop="recoveryAmount" :formatter="(a,b,c,d) => fenToYuan(c)" />
        <el-table-column label="未回收金额" align="center" prop="noRecoveryAmount" :formatter="(a,b,c,d) => fenToYuan(c)" />
      </el-table>
