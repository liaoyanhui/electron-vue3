 ...
 * @LastEditTime: 2024-03-22 17:40:02
 * @FilePath: /cbank-client/src/views/memberManagement/memberInfo/customerInformation/Modal/BindMemberCardModal.vue
-->

<template>
  <el-dialog title="绑定会员卡" :model-value="visible" width="790px" append-to-body destroy-on-close :before-close="handleBeforeClose">
    <el-form ref="bindRef" :model="form" :rules="rules" label-width="120px">
      <el-row>
        <el-col :span="11">
          <el-form-item label="客人昵称">
...
<script setup>
  import { getMemberCardTypes, addMemberCard } from '@/api/member';
