 ...
 * @LastEditTime: 2024-03-11 20:06:39
 * @FilePath: /cbank-client/src/views/memberManagement/memberInfo/memberInformation/Modal/RoomInforModa.vue
-->
<template>
  <el-dialog title="房台信息" :model-value="visible" width="908px" append-to-body destroy-on-close :before-close="handleBeforeClose">
    <el-table :data="roomList" class="ml10" ref="tableRef">
      ...
      <el-table-column label="账单号" align="center" key="manufacturerName" prop="manufacturerName" :show-overflow-tooltip="true" />
